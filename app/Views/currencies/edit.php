...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="mb-0">Edit Currency</h4>
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('currencies/update/' . $currency['id']) ?>" method="post" id="currency-form">
            <?= csrf_field() ?>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('country_name')) ? 'is-invalid' : '' ?>" 
                           id="country_name" name="country_name" value="<?= old('country_name', $currency['country_name']) ?>">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('currency_code')) ? 'is-invalid' : '' ?>" 
                           id="currency_code" name="currency_code" value="<?= old('currency_code', $currency['currency_code']) ?>" maxlength="10">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('currency_symbol')) ? 'is-invalid' : '' ?>" 
                           id="currency_symbol" name="currency_symbol" value="<?= old('currency_symbol', $currency['currency_symbol']) ?>" maxlength="5">
