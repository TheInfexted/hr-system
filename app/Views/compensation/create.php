        ...
        <form action="<?= base_url('compensation/create/' . $employee['id']) ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control date-picker <?= (isset($validation) && $validation->hasError('effective_date')) ? 'is-invalid' : '' ?>" 
                    id="effective_date" name="effective_date" value="<?= old('effective_date', date('Y-m-d')) ?>" readonly>
