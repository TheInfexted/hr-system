        ...
        <form action="<?= base_url('compensation/update/'.$compensation['id']) ?>" method="post">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control <?= (isset($validation) && $validation->hasError('effective_date')) ? 'is-invalid' : '' ?>" 
                           id="effective_date" name="effective_date" value="<?= old('effective_date', $compensation['effective_date']) ?>">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select <?= (isset($validation) && $validation->hasError('currency_id')) ? 'is-invalid' : '' ?>" 
                        ...
                        // Add the current currency if it's inactive
                        if (isset($compensation['currency_id'])) {
                            $currentCurrency = $currencyModel->find($compensation['currency_id']);
                        ...
                        ?>
                        <option value="<?= $currency['id'] ?>" <?= old('currency_id', $compensation['currency_id'] ?? 1) == $currency['id'] ? 'selected' : '' ?>>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="monthly_salary" name="monthly_salary" value="<?= old('monthly_salary', $compensation['monthly_salary']) ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="hourly_rate" name="hourly_rate" value="<?= old('hourly_rate', $compensation['hourly_rate']) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="allowance" name="allowance" value="<?= old('allowance', $compensation['allowance']) ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="parking_allowance" name="parking_allowance" value="<?= old('parking_allowance', $compensation['parking_allowance'] ?? 0) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="overtime" name="overtime" value="<?= old('overtime', $compensation['overtime']) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="epf_employee" name="epf_employee" value="<?= old('epf_employee', $compensation['epf_employee']) ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="socso_employee" name="socso_employee" value="<?= old('socso_employee', $compensation['socso_employee']) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="eis_employee" name="eis_employee" value="<?= old('eis_employee', $compensation['eis_employee']) ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text currency-symbol">$</span>
                        <input type="number" step="0.01" class="form-control" id="pcb" name="pcb" value="<?= old('pcb', $compensation['pcb']) ?>">
                    </div>
                </div>
            </div>
